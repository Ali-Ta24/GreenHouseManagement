    ...
    $.fn.dashboardModuleContainer = function (options) {
        ...
        function makeFormReady() {
            ...
            $(".dashcol").sortable({
                ...
                'start': function (event, ui) {
                    ...
                    ui.placeholder.html("<div class='dashboardControlBoxPanel portlet ui-helper-clearfix' style='width:100%;height:100%;background-color:#ffebed;text-align:center;  border-radius: 20px 5px 20px 5px;'>اینجا رها کنید<div>");
            ...
            $('#btnAddWidget').off("click").on("click", function () {
                ...
                $.ajax({
                    ...
                    dataType: "text",
                    success: function (data) {
                        //alert(dashboardStrs.widget_add_succeed);
                        ivsAlert2('success', "موفقیت", dashboardStrs.widget_add_succeed);
                ...
                if (confirm(dashboardStrs.layout_replaceWithDefaultConfirm)) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            ivsAlert2('success', "موفقیت", dashboardStrs.layout_replacedWithDefaultInfo);
                        },
                        error: function (x, y, z) {
                            ivsAlert2('error', "خطا", x + '\n' + y + '\n' + z);
                        }
                ...
                for (var i = 0; i < widgets.length; i++) {
                    ...
                    if (widgets[i].getWidget().id == widgetInstanceID) {
                        ...
                        if (currentConfigCtrl) {
                            ...
                            ivsAlert2('info', "اطلاع", dashboardStrs.widgetHasNoConfig);
                        }
                        break;
                    }
                }
            ...
            $("#widgetSettingSave").off("click").on("click", function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        ivsAlert2('success', "موفقیت", dashboardStrs.widget_settingsSaved_succeed);
                    },
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
            ...
            $("#widgetConfigSave").off("click").on("click", function (e) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        ivsAlert2('success', "موفقیت", dashboardStrs.widget_configSaved_succeed);
                    },
                    error: function (XMLHttpRequest, textStatus, errorThrown) {
        ...
        function saveLayout(ContainerStructureUniqID, showMessage) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (showMessage) {
                        ivsAlert2('success', "موفقیت", dashboard.layout_save_succeed);
                    }
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
