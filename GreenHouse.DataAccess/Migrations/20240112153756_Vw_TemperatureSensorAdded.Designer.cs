...
namespace GreenHouse.DataAccess.Migrations
{
    ...
    [Migration("20240112153756_Vw_TemperatureSensorAdded")]
    partial class Vw_TemperatureSensorAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GreenHouse.DomainEntitty.Views.TemperatureSensorViewEntity", b =>
                {
                    b.Property<string>("CreatedBy")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GreenHouse.DomainEntitty.LightIntensitySensorDetailEntity", b =>
                {
                    b.HasOne("GreenHouse.DomainEntitty.LightIntensitySensorEntity", "LightIntensitySensorEntity")
                        .WithMany()
